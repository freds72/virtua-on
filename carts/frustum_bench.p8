...
function make_cam()
	...
	return {
		...
		project_poly=function(self,p,col)
			...
			local x0,y0,x1,y1=63.5+band(0xffff,p0[1]*w0),63.5-band(0xffff,p0[2]*w0),63.5+band(0xffff,p1[1]*w1),63.5-band(0xffff,p1[2]*w1)
			local x01,y01=x0,y0
			for i=3,#p do
				local p2=p[i]
				local w2=63.5/p2[3]
				local x22,y22=63.5+band(0xffff,p2[1]*w2),63.5-band(0xffff,p2[2]*w2)
...
function start_state()
	...
	plyr=add(actors,make_plyr(track.start_pos,0)) --track.start_pos,0))
