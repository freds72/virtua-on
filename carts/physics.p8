...
-- acropolis
local track_data={
        {-40.52,0,-24.04},{-38.12,0,-24.04},
        {-40.52,0,-20.66},{-38.12,0,-20.66},
        {-40.52,0,-17.29},{-38.12,0,-17.29},
        {-40.52,0,-13.91},{-38.12,0,-13.91},
        {-40.52,0,-10.54},{-38.12,0,-10.54},
        {-40.52,0,-7.16},{-38.12,0,-7.16},
        {-40.52,0,-3.79},{-38.12,0,-3.79},
        {-40.52,0,-0.41},{-38.12,0,-0.41},
        {-40.52,0,2.96},{-38.12,0,2.96},
        {-40.52,0,5.93},{-38.12,0,5.93},
        {-40.52,0,9.31},{-38.12,0,9.31},
        {-40.52,0,12.68},{-37.96,0,12.68},
        {-40.52,0,16.06},{-37.46,0,16.06},
        {-40.62,0,19.43},{-37.39,0,19.43},
        {-40.25,0,23.17},{-37.16,0,22.12},
        {-38.58,0,26.62},{-35.64,0,24.25},
        {-36.4,0,29.24},{-33.54,0,26.75},
        {-34.23,0,31.83},{-31.38,0,29.34},
        {-32.06,0,34.41},{-29.2,0,31.93},
        {-29.89,0,37.0},{-27.04,0,34.51},
        {-27.72,0,39.59},{-24.87,0,37.1},
        {-25.55,0,42.17},{-22.7,0,39.68},
        {-23.38,0,44.76},{-20.53,0,42.27},
        {-21.21,0,47.34},{-18.36,0,44.86},
        {-19.05,0,49.93},{-16.19,0,47.44},
        {-16.95,0,52.41},{-14.07,0,49.92},
        {-14.46,0,54.97},{-11.97,0,52.14},
        {-10.91,0,56.88},{-10.07,0,53.48},
        {-7.22,0,57.26},{-7.23,0,53.79},
        {-3.85,0,57.26},{-3.85,0,53.79},
        {-0.47,0,57.26},{-0.48,0,53.79},
        {2.9,0,57.25},{2.89,0,53.78},
        {6.45,0,57.08},{6.04,0,53.69},
        {10.15,0,55.87},{8.52,0,52.86},
        {13.11,0,53.24},{10.39,0,51.17},
        {14.98,0,50.13},{11.91,0,48.59},
        {16.43,0,47.11},{13.36,0,45.54},
        {17.87,0,44.05},{14.8,0,42.49},
        {19.32,0,41.0},{16.24,0,39.44},
        {20.71,0,38.26},{17.98,0,36.22},
        {22.54,0,37.01},{21.93,0,33.7},
        {25.66,0,36.79},{25.6,0,33.41},
        {28.99,0,36.75},{29.0,0,33.38},
        {32.37,0,36.75},{32.37,0,33.39},
        {35.74,0,36.76},{35.75,0,33.39},
        {39.18,0,36.74},{39.07,0,33.37},
        {42.99,0,36.03},{41.71,0,32.92},
        {46.24,0,33.92},{43.95,0,31.45},
        {48.71,0,31.53},{46.33,0,29.15},
        {51.04,0,29.05},{48.61,0,26.72},
        {53.25,0,27.14},{51.63,0,24.22},
        {55.96,0,26.33},{55.47,0,23.0},
        {59.12,0,26.13},{59.1,0,22.75},
        {62.54,0,26.1},{62.41,0,22.73},
        {66.52,0,25.66},{65.03,0,22.29},
        {69.78,0,23.84},{67.61,0,20.71},
        {72.55,0,21.92},{70.38,0,18.79},
        {75.32,0,19.97},{73.15,0,16.85},
        {78.15,0,17.88},{75.77,0,14.96},
        {80.8,0,14.83},{77.41,0,12.86},
        {82.01,0,10.76},{77.87,0,10.56},
        {81.45,0,6.72},{77.48,0,8.06},
        {79.66,0,3.24},{76.22,0,5.64},
        {77.45,0,0.46},{74.23,0,3.16},
        {75.19,0,-2.06},{72.07,0,0.59},
        {72.76,0,-4.38},{69.86,0,-2.03},
        {70.6,0,-6.93},{67.68,0,-4.65},
        {69.05,0,-9.45},{65.59,0,-8.05},
        {68.54,0,-12.22},{64.85,0,-12.14},
        {68.73,0,-15.46},{65.04,0,-15.71},
        {68.7,0,-19.09},{65.0,0,-18.68},
        {67.91,0,-22.71},{64.37,0,-21.45},
        {66.14,0,-26.04},{63.0,0,-23.79},
        {63.87,0,-28.77},{61.01,0,-26.11},
        {61.41,0,-31.26},{58.73,0,-28.33},
        {58.92,0,-33.5},{56.23,0,-30.64},
        {56.45,0,-35.84},{53.79,0,-32.91},
        {54.01,0,-38.12},{51.32,0,-35.3},
        {51.6,0,-40.45},{48.85,0,-37.68},
        {49.03,0,-42.85},{46.59,0,-39.85},
        {45.29,0,-44.55},{44.79,0,-40.92},
        {41.08,0,-43.52},{43.0,0,-40.72},
        {38.6,0,-40.85},{40.69,0,-38.83},
        {36.63,0,-37.93},{38.1,0,-36.79},
        {34.71,0,-35.1},{36.15,0,-34.11},
        {32.83,0,-32.29},{34.27,0,-31.31},
        {30.95,0,-29.49},{32.39,0,-28.5},
        {29.07,0,-26.68},{30.52,0,-25.7},
        {27.2,0,-23.88},{28.64,0,-22.89},
        {25.31,0,-21.08},{26.77,0,-20.1},
        {23.43,0,-18.28},{24.88,0,-17.3},
        {21.54,0,-15.48},{23.0,0,-14.5},
        {19.66,0,-12.68},{21.11,0,-11.7},
        {17.77,0,-9.88},{19.23,0,-8.9},
        {15.89,0,-7.08},{17.35,0,-6.1},
        {13.99,0,-4.25},{15.63,0,-3.23},
        {12.12,0,-1.32},{14.01,0,-0.38},
        {10.79,0,2.15},{13.33,0,2.56},
        {10.44,0,5.64},{13.24,0,5.8},
        {10.25,0,9.02},{13.05,0,9.16},
        {10.07,0,12.38},{12.87,0,12.53},
        {9.76,0,15.43},{12.41,0,16.18},
        {8.4,0,17.41},{9.97,0,19.59},
        {6.04,0,18.13},{6.02,0,20.84},
        {3.6,0,17.38},{2.12,0,19.65},
        {2.06,0,15.5},{-0.5,0,16.4},
        {1.91,0,12.92},{-0.77,0,12.35},
        {3.1,0,10.32},{0.75,0,8.82},
        {4.96,0,7.56},{2.65,0,5.98},
        {6.84,0,4.75},{4.52,0,3.18},
        {8.7,0,2.03},{6.58,0,0.41},
        {10.64,0,-0.7},{8.86,0,-2.12},
        {12.58,0,-3.49},{10.99,0,-4.71},
        {14.5,0,-6.35},{13.0,0,-7.34},
        {16.38,0,-9.15},{14.93,0,-10.12},
        {18.26,0,-11.95},{16.81,0,-12.92},
        {20.14,0,-14.75},{18.69,0,-15.72},
        {22.03,0,-17.55},{20.58,0,-18.52},
        {23.91,0,-20.35},{22.46,0,-21.32},
        {25.8,0,-23.15},{24.34,0,-24.12},
        {27.68,0,-25.95},{26.23,0,-26.93},
        {29.57,0,-28.75},{28.11,0,-29.73},
        {31.43,0,-31.59},{29.95,0,-32.51},
        {33.17,0,-34.52},{31.59,0,-35.4},
        {34.68,0,-37.35},{33.21,0,-38.43},
        {36.39,0,-40.35},{34.75,0,-41.3},
        {38.02,0,-43.55},{35.85,0,-44.13},
        {38.85,0,-47.25},{36.28,0,-46.7},
        {38.04,0,-50.83},{35.54,0,-49.31},
        {35.84,0,-53.71},{33.59,0,-51.73},
        {33.8,0,-56.11},{31.34,0,-54.51},
        {33.12,0,-58.48},{30.18,0,-58.53},
        {33.53,0,-61.64},{30.55,0,-62.07},
        {33.83,0,-65.23},{30.88,0,-65.17},
        {32.96,0,-69.1},{30.32,0,-67.81},
        {30.61,0,-72.21},{28.61,0,-70.0},
        {27.92,0,-74.42},{26.08,0,-72.05},
        {25.24,0,-76.48},{23.41,0,-74.11},
        {22.57,0,-78.54},{20.73,0,-76.17},
        {19.55,0,-80.51},{18.15,0,-77.91},
        {15.74,0,-81.58},{15.56,0,-78.65},
        {11.88,0,-80.95},{12.85,0,-78.18},
        {8.58,0,-79.16},{10.29,0,-76.72},
        {5.91,0,-77.21},{7.49,0,-74.72},
        {3.41,0,-76.4},{3.64,0,-73.47},
        {0.26,0,-76.56},{0.05,0,-73.57},
        {-3.25,0,-76.77},{-3.12,0,-73.8},
        {-7.11,0,-75.93},{-5.76,0,-73.33},
        {-10.13,0,-73.87},{-8.23,0,-71.55},
        {-12.73,0,-71.73},{-10.84,0,-69.41},
        {-15.36,0,-69.57},{-13.42,0,-67.27},
        {-17.95,0,-67.41},{-16.02,0,-65.12},
        {-20.57,0,-64.95},{-18.32,0,-62.99},
        {-22.44,0,-61.46},{-19.58,0,-60.58},
        {-23.37,0,-58.17},{-20.48,0,-57.38},
        {-24.38,0,-55.33},{-21.79,0,-53.88},
        {-26.27,0,-53.19},{-24.29,0,-50.93},
        {-28.82,0,-51.06},{-26.93,0,-48.73},
        {-31.42,0,-48.91},{-29.53,0,-46.57},
        {-34.04,0,-46.7},{-32.06,0,-44.44},
        {-36.55,0,-44.13},{-34.25,0,-42.22},
        {-38.55,0,-41.07},{-35.92,0,-39.66},
        {-39.94,0,-37.68},{-37.08,0,-36.81},
        {-40.43,0,-34.08},{-37.78,0,-33.79},
        {-40.52,0,-30.6},{-38.1,0,-30.54},
        {-40.52,0,-27.18},{-38.12,0,-27.18}}
]]
...
function make_plyr(p,a,track)
	...
	body.control=function(self)	
		...
		rpm=self:steer(da/32,rpm,btn(5))
	end
...
function make_npc(p,angle,track,ai)	
	...
	body.control=function(self)
		...
		if ai==1 then			
			rpm=0.7--*lerp(0.8,1,lookahead/5)
			if abs(target_angle)>0.15 then
				brake=true
			end
		elseif ai==2 then
			rpm=0.7
			if rpm>0.56 and lookahead<3 then
				rpm=0.5
			end
		...
		elseif ai==3 then
			...
			if abs(target_angle)>0.2 or (self:get_speed()>100 and curve>2.2) then
				brake=true
			end
		elseif ai==4 then
			rpm=0.7*lerp(0.8,1,1-curve/1.5)
			if abs(target_angle)>0.15 then
				brake=true
			end
		elseif ai==5 then
			rpm=0.7
			if (self:get_speed()>200 and lookahead<2) then
				brake=true
			end
		end
		...
		rpm=self:steer(4*target_angle,rpm,brake,true)
	end
	body.update=function(self)
		body_update(self)
		rpm*=0.97
...
function make_car(p,angle,track,fix_pos)
	...
	return {
		...
		steer=function(self,steering_dt,rpm,braking,direct_steer)
			is_braking=braking
			-- for npc
			if direct_steer then
			...
			drag=lerp(0.000,0.008,drag*drag/0.12)
			local sr=mid(v_dot(right,velocity),-drag,drag)
			velocity=v_add(velocity,right,-sr)

			--add(debug_vectors,{f=steer,p=self.pos,c=8,scale=v_len(steer)})
			--add(debug_vectors,{f=velocity,p=self.pos,c=2,scale=drag})
			...
			if braking then
				...
				v_scale(velocity,direct_steer and 0.92 or 0.97)
			end
			v_scale(fwd,rpm)			
			self:apply_force_and_torque(fwd,-0.75*sa*steering_angle)
...
function _update()
	...
	if(btnp(2)) npc_track+=1
	if(btnp(3)) npc_track-=1
	npc_track=mid(npc_track,0,#npcs-1)
...
function _draw()
	...
	cam:track(plyr and plyr.pos or npcs[npc_track+1].pos)
